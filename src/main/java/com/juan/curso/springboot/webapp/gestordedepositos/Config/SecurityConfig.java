    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/GestorDeDepositos/zona/crearZona").hasRole("ADMIN")
                        .requestMatchers("/GestorDeDepositos/zona/actualizarZona").hasRole("ADMIN")
                        .requestMatchers("/GestorDeDepositos/zona/eliminarZona").hasRole("ADMIN")
                        .requestMatchers("/GestorDeDepositos/zona/buscarPorId").hasAnyRole("ADMIN","OPERATIVO")
                        .requestMatchers("/GestorDeDepositos/zona/buscarTodos").hasAnyRole("ADMIN", "OPERATIVO")
                        ...
                        .requestMatchers("/GestorDeDepositos/proveedor/buscarTodos").hasAnyRole("ADMIN")
                        .requestMatchers("/GestorDeDepositos/proveedor/buscarPorId").hasAnyRole("ADMIN")
                        .requestMatchers("/GestorDeDepositos/proveedor/crearProveedor").hasRole("ADMIN")
                        .requestMatchers("GestorDeDepositos/proveedor/actualizarProveedor").hasRole("ADMIN")
                        .requestMatchers("/GestorDeDepositos/proveedor/eliminarProveedor").hasRole("ADMIN")
                        .requestMatchers("/GestorDeDepositos/cliente/buscarTodos").hasAnyRole("ADMIN", "OPERATIVO")
                        .requestMatchers("/GestorDeDepositos/cliente/buscarPorId").hasAnyRole("ADMIN", "OPERATIVO")
                        .requestMatchers("/GestorDeDepositos/cliente/crearCliente").hasRole("ADMIN")
                        .requestMatchers("GestorDeDepositos/cliente/actualizarCliente").hasRole("ADMIN")
                        .requestMatchers("/GestorDeDepositos/cliente/eliminarCliente").hasRole("ADMIN")
